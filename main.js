...
var number = items.map(function(num) {
  return num.price;
}).reduce(function (a, b) {
  return a + b;
}) /items.length;
console.log("The average price is " + number.toFixed(2));
...
var cost = items.filter(function(num) {
...
items.filter(function(num) {
  return num.currency_code == "GBP"; 
}).forEach(function (num) {
  console.log(num.title + " costs £" + num.price);
})
...
items.filter(function(num) {
  return num.materials.indexOf("wood") >= 0; 
}).forEach(function(num) {
  console.log(num.title + " is made of wood");
})
...
items.filter(function(num) {
  return num.materials.length >= 8;
    ...
    console.log(num.title + " has " + num.materials.length + " materials:");
   num.materials.forEach(function(item) {
   console.log(item);
  })
  console.log("\n");
})
...
var sellers = items.filter(function(num) {
